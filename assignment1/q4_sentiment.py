...
def getSentenceFeatures(tokens, wordVectors, sentence):
    ...
    ### YOUR CODE HERE
    wordIdxs = [tokens[w] for w in sentence]
    wordVecs = [wordVectors[i] for i in wordIdxs]
    sentVector = np.sum(wordVecs, 0) / len(sentence)
    ### END YOUR CODE
...
def getRegularizationValues():
    ...
    ### YOUR CODE HERE
    # CC: how to scientifically determine the range of regularizers to try out?
